...
- Coverage is gated by a trailing-ratchet floor defined in `pyproject.toml [tool.coverage.report]` and a stricter gate on changed lines; the policy is ADR-0008.
