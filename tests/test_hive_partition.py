...
class TestHivePartitioning:
    ...
    def test_hive_partition_preserves_geoparquet_metadata(self, sample_parquet, temp_dir):
        ...
        with open(partition_file, 'rb') as f:
            ...
            assert geo_meta['version'] == '1.1.0', f"Wrong GeoParquet version: {geo_meta['version']}"
            ...
            if pf.num_row_groups > 0:
                ...
                for i in range(row_group.num_columns):
                    if 'geometry' in pf.schema_arrow.field(i).name:
                        ...
                        assert 'ZSTD' in compression.upper(), f"Expected ZSTD compression, got {compression}"
                        break
...
class TestPartitionFormatCompliance:
    ...
    def _verify_geoparquet_format(self, file_path):
        ...
        with open(file_path, 'rb') as f:
            ...
            assert geo_meta['version'] == '1.1.0', f"Wrong GeoParquet version in {file_path}: {geo_meta['version']}"
            ...
            assert 'geometry' in geo_meta['columns'], f"Missing geometry column metadata in {file_path}"
            ...
            if pf.num_row_groups > 0:
                ...
                for i in range(row_group.num_columns):
                    ...
                    assert 'ZSTD' in compression.upper(), f"Expected ZSTD compression in {file_path}, got {compression}"
