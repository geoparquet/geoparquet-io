...
from geoparquet_io.core.partition_by_h3 import _calculate_partition_stats
...
class TestCalculatePartitionStats:
    ...
    def test_with_files(self, tmp_path):
        ...
        total_mb, avg_mb = _calculate_partition_stats(str(tmp_path), 5)
        assert total_mb > 0
        assert avg_mb > 0
    ...
    def test_nested_folders(self, tmp_path):
        ...
        total_mb, avg_mb = _calculate_partition_stats(str(tmp_path), 1)
        assert total_mb > 0
